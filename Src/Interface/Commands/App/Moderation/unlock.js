...
module.exports = new App({
	name: 'unlock',
	description: 'Unlocks a mentioned channel in the server!',
	usage: 'unlock [channel]',
	userPermissions: ['Manage Roles'],
	options: [{
		name: 'channel',
		description: 'The channel/category you want to unlock!',
		required: false,
		type: 7,
	}],
	...
	run: async (ctx) => {
		...
		ctx.interaction.reply({
			content: `${process.env.SUCCESS_EMOJI} | Succesfully unlocked <#${channel?.id}>!`,
		});
