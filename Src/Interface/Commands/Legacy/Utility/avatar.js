...
module.exports = new App({
	...
	run: async (ctx) => {
		...
		if ((ctx.message.guild.members.cache.get(user?.id) === undefined) || (ctx.message.guild.members.cache.get(user?.id).avatar === null)) {
			if (!user?.avatar) {
		...
		else if ((ctx.message.guild.members.cache.get(user?.id).avatar !== null) && user?.avatar === null) {
			const msg = await ctx.message.reply({
				embeds: [{
					author: {
						name: user?.globalName || user?.username,
						icon_url: ctx.message.guild.members.cache.get(user?.id).displayAvatarURL({ size: 2048 }),
					},
					description: `${ctx.message.guild.members.cache.get(user?.id).avatar?.startsWith('a_') ? `[\`PNG\`](${ctx.message.guild.members.cache.get(user?.id).displayAvatarURL({ extension: 'png', size: 2048,  forceStatic: true })}) | [\`JPG\`](${ctx.message.guild.members.cache.get(user?.id).displayAvatarURL({ extension: 'jpg', size: 2048,  forceStatic: true })}) | [\`WEBP\`](${ctx.message.guild.members.cache.get(user?.id).displayAvatarURL({ extension: 'webp', size: 2048,  forceStatic: true })}) | [\`GIF\`](${ctx.message.guild.members.cache.get(user?.id).displayAvatarURL({ size: 2048 })})` : `[\`PNG\`](${ctx.message.guild.members.cache.get(user?.id).displayAvatarURL({ extension: 'png', size: 2048,  forceStatic: true })}) | [\`JPG\`](${ctx.message.guild.members.cache.get(user?.id).displayAvatarURL({ extension: 'jpg', size: 2048,  forceStatic: true })}) | [\`WEBP\`](${ctx.message.guild.members.cache.get(user?.id).displayAvatarURL({ extension: 'webp', size: 2048,  forceStatic: true })})`}`,
					image: {
						url: ctx.message.guild.members.cache.get(user?.id).displayAvatarURL({ size: 2048 }),
					},
					footer: {
						text: `Desired by ${ctx.message.author?.username}`,
						icon_url: ctx.message.author?.displayAvatarURL({ size: 2048 }),
				...
				components: [{
					...
					components: [{
						...
						min_values: 1,
						custom_id: id,
						options: ctx.message.guild.members.cache.get(user?.id).avatar?.startsWith('a_') ? [
							{
								label: 'PNG',
								value: 'png',
							}, 
			...
			collector.on('collect', async (i) => {
				if (i.isStringSelectMenu()) {
					if (i.customId === id) {
						...
						if (!ctx.message.guild.members.cache.get(user?.id).avatar) {
							return i.reply({
						...
						if (i.values[0] === 'png') {
							msg.edit({
								embeds: [{
									...
									description: `${ctx.message.guild.members.cache.get(user?.id).avatar?.startsWith('a_') ? `[\`PNG\`](${ctx.message.guild.members.cache.get(user?.id).displayAvatarURL({ extension: 'png', size: 2048,  forceStatic: true })}) | [\`JPG\`](${ctx.message.guild.members.cache.get(user?.id).displayAvatarURL({ extension: 'jpg', size: 2048,  forceStatic: true })}) | [\`WEBP\`](${ctx.message.guild.members.cache.get(user?.id).displayAvatarURL({ extension: 'webp', size: 2048,  forceStatic: true })}) | [\`GIF\`](${ctx.message.guild.members.cache.get(user?.id).displayAvatarURL({ size: 2048 })})` : `[\`PNG\`](${ctx.message.guild.members.cache.get(user?.id).displayAvatarURL({ extension: 'png', size: 2048,  forceStatic: true })}) | [\`JPG\`](${ctx.message.guild.members.cache.get(user?.id).displayAvatarURL({ extension: 'jpg', size: 2048,  forceStatic: true })}) | [\`WEBP\`](${ctx.message.guild.members.cache.get(user?.id).displayAvatarURL({ extension: 'webp', size: 2048,  forceStatic: true })})`}`,
									image: {
										url: ctx.message.guild.members.cache.get(user?.id).displayAvatarURL({ extension: 'png', size: 2048,  forceStatic: true }),
									},
									footer: {
										text: `Desired by ${ctx.message.author?.username}`,
										icon_url: ctx.message.author?.displayAvatarURL({ size: 2048 }),
							...
							msg.edit({
								embeds: [{
									...
									description: `${ctx.message.guild.members.cache.get(user?.id).avatar?.startsWith('a_') ? `[\`PNG\`](${ctx.message.guild.members.cache.get(user?.id).displayAvatarURL({ extension: 'png', size: 2048,  forceStatic: true })}) | [\`JPG\`](${ctx.message.guild.members.cache.get(user?.id).displayAvatarURL({ extension: 'jpg', size: 2048,  forceStatic: true })}) | [\`WEBP\`](${ctx.message.guild.members.cache.get(user?.id).displayAvatarURL({ extension: 'webp', size: 2048,  forceStatic: true })}) | [\`GIF\`](${ctx.message.guild.members.cache.get(user?.id).displayAvatarURL({ size: 2048 })})` : `[\`PNG\`](${ctx.message.guild.members.cache.get(user?.id).displayAvatarURL({ extension: 'png', size: 2048,  forceStatic: true })}) | [\`JPG\`](${ctx.message.guild.members.cache.get(user?.id).displayAvatarURL({ extension: 'jpg', size: 2048,  forceStatic: true })}) | [\`WEBP\`](${ctx.message.guild.members.cache.get(user?.id).displayAvatarURL({ extension: 'webp', size: 2048,  forceStatic: true })})`}`,
									image: {
										url: ctx.message.guild.members.cache.get(user?.id).displayAvatarURL({ extension: 'jpg', size: 2048,  forceStatic: true }),
									},
									footer: {
										text: `Desired by ${ctx.message.author?.username}`,
										icon_url: ctx.message.author?.displayAvatarURL({ size: 2048 }),
							...
							msg.edit({
								embeds: [{
									...
									description: `${ctx.message.guild.members.cache.get(user?.id).avatar?.startsWith('a_') ? `[\`PNG\`](${ctx.message.guild.members.cache.get(user?.id).displayAvatarURL({ extension: 'png', size: 2048,  forceStatic: true })}) | [\`JPG\`](${ctx.message.guild.members.cache.get(user?.id).displayAvatarURL({ extension: 'jpg', size: 2048,  forceStatic: true })}) | [\`WEBP\`](${ctx.message.guild.members.cache.get(user?.id).displayAvatarURL({ extension: 'webp', size: 2048,  forceStatic: true })}) | [\`GIF\`](${ctx.message.guild.members.cache.get(user?.id).displayAvatarURL({ size: 2048 })})` : `[\`PNG\`](${ctx.message.guild.members.cache.get(user?.id).displayAvatarURL({ extension: 'png', size: 2048,  forceStatic: true })}) | [\`JPG\`](${ctx.message.guild.members.cache.get(user?.id).displayAvatarURL({ extension: 'jpg', size: 2048,  forceStatic: true })}) | [\`WEBP\`](${ctx.message.guild.members.cache.get(user?.id).displayAvatarURL({ extension: 'webp', size: 2048,  forceStatic: true })})`}`,
									image: {
										url: ctx.message.guild.members.cache.get(user?.id).displayAvatarURL({ extension: 'webp', size: 2048,  forceStatic: true }),
									},
									footer: {
										text: `Desired by ${ctx.message.author?.username}`,
										icon_url: ctx.message.author?.displayAvatarURL({ size: 2048 }),
			...
			const msg = await ctx.message.reply({
				embeds: [{
					author: {
						name: user?.globalName || user?.username,
						icon_url: user?.displayAvatarURL({ size: 2048 }) || ctx.message.guild.members.cache.get(user?.id).displayAvatarURL({ size: 2048 }),
					},
